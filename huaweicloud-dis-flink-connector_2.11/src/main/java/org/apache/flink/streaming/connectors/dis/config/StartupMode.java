...
import org.apache.flink.streaming.connectors.dis.internals.DisStreamPartitionStateSentinel;

/**
 * Startup modes for the DIS Consumer.
 */
@Internal
public enum StartupMode {

	/** Start from committed offsets in DIS of a specific consumer group (default). */
	GROUP_OFFSETS(DisStreamPartitionStateSentinel.GROUP_OFFSET),

	/** Start from the earliest offset possible. */
	EARLIEST(DisStreamPartitionStateSentinel.EARLIEST_OFFSET),

	/** Start from the latest offset. */
	LATEST(DisStreamPartitionStateSentinel.LATEST_OFFSET),
