...
/**
 * A simple wrapper for using the DeserializationSchema with the DisDeserializationSchema
 * interface.
 * @param <T> The type created by the deserialization schema.
 */
@Internal
public class DisDeserializationSchemaWrapper<T> implements DisDeserializationSchema<T> {

	private static final long serialVersionUID = 2651665280744549932L;

	private final DeserializationSchema<T> deserializationSchema;

	public DisDeserializationSchemaWrapper(DeserializationSchema<T> deserializationSchema) {
