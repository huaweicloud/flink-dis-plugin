...
package org.apache.flink.streaming.connectors.dis.internals.metrics;

import org.apache.flink.annotation.Internal;

/**
 * A collection of DIS consumer metrics related constant strings.
 *
 * <p>The names must not be changed, as that would break backward compatibility for the consumer's metrics.
 */
@Internal
public class DISKafkaConsumerMetricConstants {

	public static final String DIS_CONSUMER_METRICS_GROUP = "DISKafkaConsumer";
