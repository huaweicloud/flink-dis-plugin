 ...
 */
@Internal
public class DisStreamPartitionLeader implements Serializable {
	...
	private final DisStreamPartition topicPartition;
	private final int cachedHash;

	public DisStreamPartitionLeader(DisStreamPartition topicPartition, Node leader) {
	...
	public DisStreamPartition getTopicPartition() {
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof DisStreamPartitionLeader)) {
			return false;
		}

		DisStreamPartitionLeader that = (DisStreamPartitionLeader) o;
