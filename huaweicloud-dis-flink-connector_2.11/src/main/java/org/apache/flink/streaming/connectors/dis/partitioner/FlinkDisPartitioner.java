...
package org.apache.flink.streaming.connectors.dis.partitioner;
...
/**
 * A {@link FlinkDisPartitioner} wraps logic on how to partition records
 * across partitions of multiple Kafka topics.
 */
@PublicEvolving
public abstract class FlinkDisPartitioner<T> implements Serializable {
