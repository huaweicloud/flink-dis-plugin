...
public enum OffsetCommitMode {
	...
	/** Commit offsets back to DIS only when checkpoints are completed. */
	ON_CHECKPOINTS,

	/** Commit offsets periodically back to DIS, using the auto commit functionality of internal Kafka clients. */
	KAFKA_PERIODIC;
}
