...
public class DisStreamPartitionState<KPH> {
	...
	private final DisStreamPartition partition;
	...
	public DisStreamPartitionState(DisStreamPartition partition, KPH kafkaPartitionHandle) {
		this.partition = partition;
		this.kafkaPartitionHandle = kafkaPartitionHandle;
		this.offset = DisStreamPartitionStateSentinel.OFFSET_NOT_SET;
		this.committedOffset = DisStreamPartitionStateSentinel.OFFSET_NOT_SET;
	}
	 ...
	 */
	public final DisStreamPartition getKafkaTopicPartition() {
		return partition;
	}
	...
	public final boolean isOffsetDefined() {
		return offset != DisStreamPartitionStateSentinel.OFFSET_NOT_SET;
	}
